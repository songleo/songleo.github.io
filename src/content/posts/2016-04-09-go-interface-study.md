---
title: "go语言接口学习"
description: "刚开始学习go语言的时候，看代码中某个类型实现了Error()方法，然后就可以将该类型赋值给error类型。当时还没学习接口，不懂为什么可以这样赋值。学习接口以后，才明白怎么回事。查看go源码，发现内置类型error其实是一个接口类型，并实现了Error()方法，如下："
pubDatetime: 2016-04-09T23:40:32+08:00
---
