...
- 熟练掌握 Kubernetes 网络：Ingress Controller (NGINX)、Network Debugging
- 熟练掌握 Kubernetes 存储：PV/PVC、Storage Class
- 熟练掌握 Kubernetes 应用部署：Helm、Kustomize、GitOps (Flux CD、ArgoCD)
- 熟练掌握 Kubernetes 监控和可观测性：Prometheus Operator、Grafana、Alertmanager
