---
title: "可观察性的检查表"
description: "[ ] 可以收集到重要的业务指标数据，例如当前有多少用户同时在线 [ ] 可以跟踪重要业务事件，例如用户取消订单事件 [ ] 日志中记录了关键错误和故障信息，例如支付失败 [ ] 可以监控到系统的健康状态，例如可以监控到数据库能正常读写，这是一个健康的状态，可以提供服务"
pubDatetime: 2023-01-11T00:12:05+08:00
tags: ["可观测性", "学习笔记"]
---
