---
title: "az-104备考总结"
description: "azure的网络安全组(nsg)和其应用的虚拟网络(vnet)必须位于同一个区域，不同区域的nsg和vnet间是无法直接关联的，这是由于数据中心的物理位置和数据延迟等因素决定的，以确保网络性能和安全性"
pubDatetime: 2023-07-29T00:12:05+08:00
tags: ["azure", "最佳实践", "考试认证"]
---
